...
public class GenericParadigmUtil {
    ...
    public static int getInterfacePosition(Object object, Class target) {
        if (object == null || target == null) {
            return -1;
        }
        return getInterfacePosition(object.getClass(), target);
    }

    public static int getInterfacePosition(Class clazz, Class target) {
        ...
        if (genericInterfaces != null) {
            ...
            for (int i = 0; i < length; i++) {
                genericInterface = genericInterfaces[i];
                temp = null;
                if (genericInterface instanceof Class) {
                    temp = (Class) genericInterface;
                } else if (genericInterface instanceof ParameterizedType) {
                    temp = (Class) ((ParameterizedType) genericInterface).getRawType();
                }
